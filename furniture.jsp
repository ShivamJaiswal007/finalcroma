					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown active">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Furniture</span></a>
							
							</li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> Sports & Books <b class="caret"></b></font></span></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="furniture.html"><img class="first-slide" src="images/s2.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="television.html"><img class="second-slide " src="images/s3.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
         <a href="mobiles.html"> <img class="third-slide " src="images/s4.jpg" alt="Third slide"></a>
				...
				<div class=" con-w3l agileinf">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="images/Furniture/<%=sr%>.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">

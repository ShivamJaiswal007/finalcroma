...
ResultSet rs=st.executeQuery("select * from psb where priority='"+s500+"' ");
while(rs.next())
{
...
<div id="picture-frame">
			<img src="images/BS/<%=session.getAttribute("Priority")%>.png" data-src="images/BS/<%=session.getAttribute("Priority")%>.png" alt="" class="img-responsive"/>
		</div>

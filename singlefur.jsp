...
ResultSet rs=st.executeQuery("select * from pfurniture where priority='"+s500+"' ");
while(rs.next())
{
...
<div id="picture-frame">
			<img src="images/Furniture/<%=session.getAttribute("Priority")%>.png" data-src="images/Furniture/<%=session.getAttribute("Priority")%>.png" alt="" class="img-responsive"/>
		</div>

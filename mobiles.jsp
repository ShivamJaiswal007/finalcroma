					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li  class="dropdown active">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>Mobiles</span></a>
							</li>
							<li class="dropdown">
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span><span> Sports & Books <b class="caret"></b></span></a>
								<ul class="dropdown-menu multi multi2">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
  ...
  <!---->
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
           <a href="furniture.html"><img class="third-slide " src="images/25.jpg" alt="Third slide"></a>
...
<!--content-->
		...
		<div class="container">
			<div class="spec ">
				...
				<%
{
	session.setAttribute("category","Mobile");
	int sr=1;
...
%>
							<div class="col-md-3 pro-1">
								...
								<div data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="images/Mobile/<%=sr%>.jpeg" class="img-responsive" alt="">
									</div>
									<div class="mid-1">
										<div class="women">

...
ResultSet rs=st.executeQuery("select * from pmobile where priority='"+s500+"' ");
while(rs.next())
{
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li ><a class="hyper"><span>Home</span></a></li>	
...
<div id="picture-frame">
			<img src="images/Mobile/<%=session.getAttribute("Priority")%>.jpeg" data-src="images/Mobile/<%=session.getAttribute("Priority")%>.jpeg" alt="" class="img-responsive"/>
		</div>

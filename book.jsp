					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							...
							<li class="dropdown  active">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span> Sports & Books </font></span></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <a href="book.html"><img class="first-slide" src="images/5.jpg" alt="First slide"></a>
       
        </div>
        <div class="item">
          <a href="mobiles.html"><img class="second-slide " src="images/7.jpg" alt="Second slide"></a>
         
        </div>
        <div class="item">
          <a href="furniture.html"><img class="third-slide " src="images/31.jpg" alt="Third slide"></a>
...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			...
			<h6>Cook Books</h6>
			<p>Unleash your Chef!!!</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="images/6.jpg" class="img-responsive" alt="">
			</a>
			<h6>Children Books</h6>
...
%>
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="images/BS/<%=sr%>.jpeg" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
